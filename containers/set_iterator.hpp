...
namespace ft
{
	...
	class set_iterator
	{
		...
		public :
			...
			set_iterator() : _node(NULL), _nil(NULL) {}
			set_iterator(node_pointer nil) : _node(NULL), _nil(nil) {}
			set_iterator(node_pointer node, node_pointer nil) : _node(node), _nil(nil) {}
			set_iterator(const set_iterator& other, node_pointer nil) : _node(other._node), _nil(nil) {}
			~set_iterator() {}
			...
			operator set_iterator<const T, const V>() const {
        	    return (set_iterator<const T, const V>(this->_node, this->_nil));
        	}
